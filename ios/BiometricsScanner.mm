            ...
            if(authError) {
                switch(authError.code){
                    ...
                    case LAErrorUserFallback:
                        reject([NSString stringWithFormat:@"%li",  ERROR_BIOMETRIC_FALLBACK], @"User cancels", error);
                        break;
                    ...
                    case LAErrorBiometryLockout:
                        reject([NSString stringWithFormat:@"%li",  ERROR_BIOMETRIC_LOCK_OUT], @"User must enroll", error);
                        break;
